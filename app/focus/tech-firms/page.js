...
async function getRelevantStacks() {
  // Get stacks relevant to tech firms (data-first focus)
  const stacks = await client.fetch(starterStacksByFocusQuery, { focusTag: 'data-first' });
  return stacks.slice(0, 3);
}

export default async function TechFirmsPage() {
          ...
          <section className="px-4 sm:px-8 lg:px-16 py-16">
            <div className="max-w-5xl mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-center mb-4">
                Starter Stacks for Context
              </h2>
              <p className="text-white/60 text-center mb-8 max-w-2xl mx-auto">
                See how manufacturing tech gets combined in real deployments.
              </p>
              <div className="grid md:grid-cols-3 gap-6">
