...
export const metadata = {
  ...
  description: "A multi-agent AI system that runs debates, stress-tests ideas, and takes action — through Discord or a local markdown file. Open source.",
};
  ...
  return (
    <div className="min-h-screen text-white" style={{ background: "linear-gradient(135deg, #0f0f1a 0%, #1a1a2e 50%, #0d0d1f 100%)" }}>
        ...
        <div className="rounded-2xl p-8 md:p-10" style={{ background: "rgba(99,102,241,0.08)", border: "1px solid rgba(99,102,241,0.2)" }}>
          ...
          <div className="mt-8 pt-6" style={{ borderTop: "1px solid rgba(99,102,241,0.2)" }}>
            <p className="text-base" style={{ color: "#c7d2fe" }}>
              <strong className="text-white">Agent Factory routes your question to multiple agents simultaneously,</strong> forces one to argue against the consensus, then synthesizes — so the output already reflects the best case and the worst case. You get a verdict, not a draft.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-6 pb-16">
        ...
        <p className="mb-8 text-sm" style={{ color: "#6b7280" }}>Agent Factory uses CLI tools that authenticate with your existing subscriptions. Configure only what you have — unconfigured agents are skipped automatically.</p>
